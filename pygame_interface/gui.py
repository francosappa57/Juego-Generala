...
def imp_dados_actuales(dados, pantalla, dado_seleccionado, imagenes, elegir):
    """
        ...
        Returns:
            retorna una lista con la posicion de cada dado
    """
    pos_dados = []
    x_base = 50
    y_base = 150
